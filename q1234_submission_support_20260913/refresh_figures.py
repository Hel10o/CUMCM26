"""Refresh referenced paper figures without rebuilding accepted numerical files.
...
BASELINE_COMMIT = "dfe7b2911672deacdea62096fc409bcf04855fdf"
BASELINE_ZIP_SHA256 = "ea93f1b834deb57564685f415082b9c7e9c6e665763875099caf4f159d490b9e"
EVIDENCE = package.BASE / "evidence" / "q2_figure_refresh_20260913"
...
def main():
    ...
    baseline_report = EVIDENCE / "baseline_package_report.json"
    ...
    assert len(old_figures) == 11 and len(current_figures) == 12
    ...
    temporary = output_dir / "A题_支撑材料.refresh.tmp"
    ...
    report = {
        "operation": "paper figure and source-list packaging refresh only",
        "baseline_commit": BASELINE_COMMIT,
        "baseline_zip_sha256": BASELINE_ZIP_SHA256,
        "baseline_report": "q2_figure_refresh_20260913/baseline_package_report.json",
        "paper_table_numerical_validation": "not rerun; original 60-value check retained in baseline report",
