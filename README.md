...
最新一轮按用户要求，将摘要关键词及PDF元数据中的“材料坐标”改为“热质耦合”；正文术语与7图字体版保持。PDF仍为157页（摘要1页、正文29页、附录127页），37项PDF检查通过，其余156页像素不变。PDF、源稿ZIP与清单已更新，见[关键词修订记录](paper/q1234_draft_v1/evidence/keyword_revision_20260912/关键词修订记录.md)。
