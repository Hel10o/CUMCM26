...
当前论文已同步改善正文排版：保留小四字号，增加行距、段距、标题与公式留白、表格行高及图表间距，并调整三处浮动位置与第四问图前标题分页。正文含 AI 声明及参考文献共 22 页，仍低于 30 页上限；见[正文排版修订与验收](paper/q1234_draft_v1/evidence/body_spacing_20260912/正文排版修订说明.md)。
