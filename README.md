...
当前论文已同步改善正文排版：保留小四字号，增加行距、段距、标题与公式留白、表格行高及图表间距，并调整三处浮动位置与第四问图前标题分页。正文含 AI 声明及参考文献共 22 页，仍低于 30 页上限；见[正文排版修订与验收](paper/q1234_draft_v1/evidence/body_spacing_20260912/正文排版修订说明.md)。现版 10 个一级标题以“一、二、三……”编号并各占一行，见[一级标题修订记录](paper/q1234_draft_v1/evidence/section_titles_20260912/一级标题调整说明.md)。

论文摘要现已参照用户给出的范文，以加粗“针对问题一／二／三／四”各自起段，按“任务与建模、求解方法、主要结果、结果解释”展开，并选择性加粗真实方法、比较前提与关键数值，见[最新摘要](paper/q1234_draft_v1/evidence/abstract_sample_20260912/摘要仿写稿.md)及[仿写修订与验收](paper/q1234_draft_v1/evidence/abstract_sample_20260912/摘要仿写说明.md)。摘要采用 11.5 pt 字号、18 pt 行距和 5 pt 段间距，保留单页，沿用此前[间距调整与官方规范核验](paper/q1234_draft_v1/evidence/abstract_spacing_20260912/摘要间距调整说明.md)；本次正文、附录及科学结果不变。
