...
本轮仅放大问题一6.3热图字体、居中子图标题和色标说明，并将问题一流程图7个框改为白底。正文文字、数据和结果不变；PDF仍158页（正文30页），仅物理第7、10页变化，其余156页像素一致。见[图片修订记录](paper/q1234_draft_v1/evidence/q1_legibility_20260913/问题一图片字号与底色修订记录.md)和[当前两图入口](paper/q1234_draft_v1/figures/q1_legibility/README.md)。
