...
最新一轮仅统一7幅正文图的字体：中文为宋体，英文、数字及坐标刻度为 Times New Roman；数据、文字、字号、图尺寸和流程图行距保持。PDF仍为157页（摘要1页、正文29页、附录127页），37项PDF检查与56项独立字体检查通过；仅7个图页变化，其余150页像素一致。当前图在 `figures/font_revision/`（相对于论文目录），重绘入口为 `build_font_assets.py`；PDF、源稿ZIP与清单已更新，见[图片字体修订记录](paper/q1234_draft_v1/evidence/figure_fonts_20260912/图片字体修订记录.md)。
...
当前论文已补齐“通用方程→分问代入与化简→离散与求解→结果”的推导链，四问均有与实际代码相符的求解公式，见[四问推导补充说明](paper/q1234_draft_v1/evidence/derivations_20260912/四问公式推导补充说明.md)和[公式与代码对应表](paper/q1234_draft_v1/evidence/derivations_20260912/公式与代码对应表.md)。当前正文为29页（含AI声明与参考文献），总PDF为157页，页面核验见页首图表修订记录；保留小四字号与放宽后的行距、段距、公式和图表留白，见此前[正文排版修订](paper/q1234_draft_v1/evidence/body_spacing_20260912/正文排版修订说明.md)。10个一级标题继续以“一、二、三……”编号并各占一行，见[一级标题修订记录](paper/q1234_draft_v1/evidence/section_titles_20260912/一级标题调整说明.md)。
