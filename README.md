...
本轮仅将第三问图7的七个彩色填充改为白色，保留文字、字体、框形和箭头布局；正文只切换图路径。正式PDF、源稿及支撑包同步更新，实际检查见[去色修订记录](paper/q1234_draft_v1/evidence/q3_white_20260913/第三问流程图去色记录.md)和[当前白底流程图](paper/q1234_draft_v1/figures/q3_white/README.md)。
