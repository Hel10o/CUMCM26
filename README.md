...
本轮保留6.4“数值验证与适用范围”标题，按用户确认的Word对照建议完善结果承接、检验目的与总结。全部原数字、数学表达和适用范围保留；只改6.4文字，图片及其他章节不变。PDF仍158页（正文30页），仅物理第11页改变，其余157页像素一致。见[6.4行文修订记录](paper/q1234_draft_v1/evidence/q1_64_wording_20260913/6.4行文修订记录.md)。
