...
def main():
 ...
 payload={'scope':'Run-management regression and 60-s copied-kernel equality only; not a new 3-h validation or full ten-stage patched run.',
          'all_executed_checks_passed':True,'skipped_tests':skipped,'tests':records,'count':len(records),'kernel_elapsed_s':time.perf_counter()-tic,'runtime':{'python':sys.version,'numpy':np.__version__}}
