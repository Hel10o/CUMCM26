...
正文段落、标题、公式、表格及图表间距已统一放宽，并调整三处图表浮动位置；正文保留小四字号，使用 1.30 行距系数与 5 pt 段间距，见[正文排版修订说明](evidence/body_spacing_20260912/正文排版修订说明.md)。现版在提交 `4ac28432334b34f5d20d33d35115cf88d39a129c` 上，将 10 个正文一级标题改为“一、”至“十、”编号，每个标题独占一行；二级编号保持 2.1、3.1 等。正文含 AI 声明和参考文献共 22 页；摘要 1 页、附录 127 页，总计 150 页。见[一级标题调整说明](evidence/section_titles_20260912/一级标题调整说明.md)及[最新 PDF 检查](evidence/section_titles_20260912/pdf_validation.json)。以下历次验收记录保留，当前 PDF 状态以上述最新检查为准。
