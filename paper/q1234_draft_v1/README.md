...
最新一轮仅统一7幅正文图的字体：中文为宋体，英文、数字及坐标刻度为 Times New Roman；数据、文字、字号、图尺寸和流程图行距保持。PDF仍为157页（摘要1页、正文29页、附录127页），37项PDF检查与56项独立字体检查通过；仅7个图页变化，其余150页像素一致。当前图在 `figures/font_revision/`（相对于论文目录），重绘入口为 `build_font_assets.py`；PDF、源稿ZIP与清单已更新，见[图片字体修订记录](evidence/figure_fonts_20260912/图片字体修订记录.md)。
