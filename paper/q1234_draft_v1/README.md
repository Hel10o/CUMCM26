...
最新摘要措辞修订读取提交 `ff5011e441e7ba47904549db0cc754a506b4a4d9`。第三、四问段改收在有范围的正面证据与条件对照结果上，关键词前用普通字体说明约 2.39 天、2.13 天与题述周期一致；结论末句改为接续式。第一、二问摘要及其结论逐字保留，加粗块仍 24 个、可见字符代理数 347→267。任务 C 对第一至七章逐句配对，实际删除为空，所有候选的保护依据见[语义去重清单](evidence/wording_revision_20260912/semantic_dedup.md)。

当前 PDF 仍 **156 页**：摘要 **1 页**，正文 **28 页**（物理页 2–29，含 AI 声明和参考文献），附录 127 页。37 项 PDF 检查通过，六张题设表 279 个显示单元格保持；全页像素比较只有第 1、28 页变化，已逐页目视，其他 154 页相同。现行检查口径为“摘要不得强于正文”，未完成事项继续保留在第七章、9.3、9.4。详见[本轮修订记录](evidence/wording_revision_20260912/摘要语气与措辞修订记录.md)、[摘要新旧全文](evidence/wording_revision_20260912/abstract_comparison.md)及[九项清单](evidence/wording_revision_20260912/consistency_checklist.md)。没有重跑求解、参数情景或作图。
