...
最新一轮按用户要求，将摘要关键词及PDF元数据中的“材料坐标”改为“热质耦合”；正文术语与7图字体版保持。PDF仍为157页（摘要1页、正文29页、附录127页），37项PDF检查通过，其余156页像素不变。PDF、源稿ZIP与清单已更新，见[关键词修订记录](evidence/keyword_revision_20260912/关键词修订记录.md)。
...
摘要、题意与统一假设、分问物性、传热传质方程和数值方法、四问结果、六张题设表、七幅图、二维与环境检验、物理适用范围、结论、AI声明、参考文献和完整代码附录均已合入。
