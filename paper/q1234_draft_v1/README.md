...
最新一轮按用户确认，将第三问摘要改为仅展示一维模型结果，以“最终干燥时长由轴心含水率决定。”收尾；正文二维证据保留。同时保留用户写入的新首段、首行2em缩进及已删除的摘要独立天数句。摘要字号与间距不改，最终PDF为157页（摘要1页、正文29页、附录127页）；37项PDF检查通过，其余156页与上一提交像素一致。见[本轮修订记录](evidence/abstract_q3_1d_20260912/第三问摘要一维结果与首段缩进修订记录.md)。
