...
ROOT = BASE.parents[1]
OUT = BASE / 'figures/q3_white'
EVIDENCE = BASE / 'evidence/q3_white_20260913'
BASELINE = '6496064c62f5495d0e4d324905bff0cd782cb2db'
...
def main():
    ...
    fills = {node['id']: '#FFFFFF' for node in specification['nodes']}
    ...
    result.update({
        ...
        'reference_image': {'path': str(REFERENCE),
                            ...
                            'adopted': 'Same seven rectangular nodes and six arrows, with all node fills changed to white.',
