...
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{figures/question_workflows/q1_workflow.pdf}
\caption{问题一求解流程}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.94\textwidth]{figures/font_revision/q1_profiles.pdf}
...
\setlength{\intextsep}{10pt}
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{figures/ch6_revision/q1_workflow.pdf}
...
\subsection{常热物性方程与初边值条件}
题设圆柱药材长$25\unit{cm}$、半径$2\unit{cm}$\cite{problem}。
...
\begin{figure}[htbp]
\centering\includegraphics[width=\linewidth]{figures/ch6_revision/q1_boundary.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.94\textwidth]{figures/ch6_revision/q1_profiles.pdf}
\caption{第一问的时间--径向温湿场。横轴为时间，纵轴为径向距离；左、右色标分别表示温度与干基含水率，均由已保存采样值着色。}
\label{fig:q1-profiles}
\end{figure}
