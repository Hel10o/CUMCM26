...
def main():
    ...
    fig = plt.figure(figsize=cm(15, 8.0))
    # Keep the original logical coordinates and point sizes; stretch only vertical spacing.
    ...
    details = {
        ...
        'dimensions_cm': [15, 8.0], 'font': font, 'minimum_font_pt': 7.4,
