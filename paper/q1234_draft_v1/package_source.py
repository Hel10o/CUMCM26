...
roots = ["main.tex", "ai_details.tex", "body_preview.tex", "build.ps1",
         "build_assets.py", "build_dimension_reduction.py", "build_visual_assets.py", "build_refined_assets.py", "build_workflow_spacing.py", "build_font_assets.py", "figures/dimension_reduction.png", "validate_paper.py", "package_source.py", "README.md"]
