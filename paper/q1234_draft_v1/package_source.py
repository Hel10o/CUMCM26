...
files.append(BASE / 'build_legibility_q2.py')
files.extend((BASE / 'figures' / 'legibility_q2').glob('*.png'))
files.append(BASE / 'build_legibility_schematics.py')
files.extend((BASE / 'figures' / 'legibility_schematics').glob('*.png'))
files.append(BASE / 'build_legibility_process.py')
files.extend((BASE / 'figures' / 'legibility_process').glob('*.png'))
files.append(BASE / 'build_legibility_validation.py')
files.extend((BASE / 'figures' / 'legibility_validation').glob('*.png'))
