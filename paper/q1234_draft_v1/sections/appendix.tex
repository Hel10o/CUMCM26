...
代码导览：第一问见\nolinkurl{q1_solver.py}；第二、三问全程见\nolinkurl{solve_unified_q23.py}，第三问现行表见\nolinkurl{q3_refined_reference.py}与\nolinkurl{export_workbook.py}；第四问见\nolinkurl{q4_spectral.py}，二维检验见\nolinkurl{geometry_solver_executed.py}。
