...
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{figures/q3_white/q3_workflow.pdf}
...
问题三要求药材各处的干基含水率严格低于
$C_{\mathrm{lim}}=0.15\unit{kg/kg}$\cite{problem}。
...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=0.93\textwidth]{figures/font_revision/q3_q4_drying.pdf}
