...
ROOT = BASE.parents[1]
OUT = BASE / 'figures/visual_revision'
EVIDENCE = BASE / 'evidence/figure_revision_20260912'
BASELINE = 'a2c8baf0175c29a4fe21145ba222cb8e19d84199'
INK = '#253E4A'
TEAL = '#176B80'
AMBER = '#C77C35'
GREY = '#6C7C83'
